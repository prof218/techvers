...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-20">
      ...
      <div className="absolute top-1/4 -right-20 w-72 h-72 bg-[#6366f1]/10 rounded-full blur-[120px]" />
      <div className="absolute bottom-1/4 -left-20 w-72 h-72 bg-[#8b5cf6]/10 rounded-full blur-[120px]" />
      ...
      >
        <div className="p-8 rounded-2xl border border-[var(--border)] bg-[var(--surface)] shadow-xl">
          ...
          <p className="mt-6 text-center text-sm text-[var(--foreground-muted)]">
            ...
            <Link href="/auth/signin" className="text-[var(--primary)] font-medium hover:underline">
              Sign in
            </Link>
          </p>
